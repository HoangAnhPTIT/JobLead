import { configureAuth, clearSession, getSessionFromCookies, loginCandidate, loginEmployer, setCookie } from "@/packages/auth-sdk";
...
export { clearSession, getSessionFromCookies, loginCandidate, loginEmployer, setCookie } from "@/packages/auth-sdk";
