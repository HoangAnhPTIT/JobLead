...
const CvTemplateLayout = ({ modalType, setModalType, children }) => {
	return (
		<>
										...
										<Tooltip
											...
											title={
												<div className="text-33">
													...
													<div>
														<p>
															Mô tả, giới thiệu về định hướng công việc của bản
															thân trong tương lai ngắn hạn hoặc dài hạn
														</p>
													</div>
												</div>
											}
										...
										<Tooltip
											...
											title={
												<div className="text-33">
													...
													<div>
														<p>
															Thông tin các chứng chỉ, bằng cấp, học vấn của bạn
														</p>
													</div>
												</div>
											}
			...
			<ModalGeneralInfo modalType={modalType} setModalType={setModalType} />
		</>
	);
};
